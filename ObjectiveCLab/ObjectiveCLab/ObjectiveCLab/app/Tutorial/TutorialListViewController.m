...
- (void)viewDidLoad {
    self.pListFileName = @"TutorialList";
    self.listCellName = @"TutorialListCell";
    
    [super viewDidLoad];
    
    self.title = titleTutorial;
...
- (void)animationPrompt:(BOOL)animated {
    self.navigationItem.prompt = englishTutorial;
}
